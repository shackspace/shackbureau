...
{% if subject %}\subject{% templatetag openbrace %}{{ subject }}{% templatetag closebrace %}{% endif %}

\opening{% templatetag openbrace %}{% if opening %}{{ opening }}{% endif %}{% templatetag closebrace %}
